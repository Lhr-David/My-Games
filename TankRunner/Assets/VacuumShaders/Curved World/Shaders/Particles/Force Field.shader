...
Shader "MyShaders/Force Field Curved World"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "RenderType"="Transparent" "IgnoreProjector"="True" "Queue"="Transparent" 		       "CurvedWorldTag" = "Particles/Blend"
...
#include "../cginc/CurvedWorld_Base.cginc"
            ...
            {
                v2f output;
				V_CW_TransformPoint(vert.vertex);
